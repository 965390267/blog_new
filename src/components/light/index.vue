<template>
  <div id="lampadario" @click="changebg">
    <input type="radio" name="switch" v-model="switchval" value="on" />
    <input type="radio" name="switch" v-model="switchval" value="off" checked="checked" />
...
export default {
  ...
  methods:{
    ...
    this.$emit('changeBackground',this.switchval=='off'?true:false)
    }
  }
}
</script>
